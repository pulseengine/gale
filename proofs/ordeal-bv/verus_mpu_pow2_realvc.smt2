...
;; Source obligation: gale src/mpu.rs:98 (is_power_of_two, n>0 && n&(n-1)==0 <=> pow2)
;; This is the exact SMT-LIB2 log Verus/AIR streams to Z3 for the leaf,
;; carried verbatim as ordeal test fixture verus_gale_mpu_pow2_raw.smt2 (ordeal 0.14.0).
...
(declare-const fuel%lib!mpu.MIN_REGION_SIZE. FuelId)
(declare-const fuel%lib!mpu.MAX_REGIONS_V7. FuelId)
(declare-const fuel%lib!mpu.MAX_REGIONS_V8. FuelId)
(declare-const fuel%lib!mpu.is_pow2_spec. FuelId)
...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.arrow_0. fuel%vstd!std_specs.option.is_some.
  fuel%vstd!std_specs.option.is_none. fuel%vstd!std_specs.option.spec_unwrap. fuel%vstd!pervasive.strictly_cloned.
  ...
  fuel%vstd!view.impl&%14.view. fuel%vstd!view.impl&%20.view. fuel%vstd!view.impl&%26.view.
  fuel%vstd!view.impl&%42.view. fuel%lib!mpu.MIN_REGION_SIZE. fuel%lib!mpu.MAX_REGIONS_V7.
  fuel%lib!mpu.MAX_REGIONS_V8. fuel%lib!mpu.is_pow2_spec. fuel%vstd!array.group_array_axioms.
...
(declare-sort slice%<lib!mpu.MpuRegion.>. 0)
(declare-sort allocator_global%. 0)
(declare-datatypes ((core!option.Option. 0) (vstd!raw_ptr.PtrData. 0) (lib!mpu.MpuRegion.
   0
  ) (tuple%0. 0) (tuple%1. 0)
  ...
  ) ((lib!mpu.MpuRegion./MpuRegion (lib!mpu.MpuRegion./MpuRegion/?base Int) (lib!mpu.MpuRegion./MpuRegion/?size
     Int
    ) (lib!mpu.MpuRegion./MpuRegion/?attr Int)
   )
...
(declare-fun lib!mpu.MpuRegion./MpuRegion/base (lib!mpu.MpuRegion.) Int)
(declare-fun lib!mpu.MpuRegion./MpuRegion/size (lib!mpu.MpuRegion.) Int)
(declare-fun lib!mpu.MpuRegion./MpuRegion/attr (lib!mpu.MpuRegion.) Int)
(declare-fun tuple%1./tuple%1/0 (tuple%1.) Poly)
(declare-fun TYPE%core!option.Option. (Dcr Type) Type)
(declare-const TYPE%vstd!raw_ptr.Provenance. Type)
(declare-fun TYPE%vstd!raw_ptr.PtrData. (Dcr Type) Type)
(declare-fun TYPE%vstd!seq.Seq. (Dcr Type) Type)
(declare-const TYPE%lib!mpu.MpuRegion. Type)
(declare-fun TYPE%tuple%1. (Dcr Type) Type)
(declare-fun FNDEF%core!clone.Clone.clone. (Dcr Type) Type)
(declare-fun Poly%vstd!raw_ptr.Provenance. (vstd!raw_ptr.Provenance.) Poly)
(declare-fun %Poly%vstd!raw_ptr.Provenance. (Poly) vstd!raw_ptr.Provenance.)
(declare-fun Poly%slice%<lib!mpu.MpuRegion.>. (slice%<lib!mpu.MpuRegion.>.) Poly)
(declare-fun %Poly%slice%<lib!mpu.MpuRegion.>. (Poly) slice%<lib!mpu.MpuRegion.>.)
...
(declare-fun Poly%lib!mpu.MpuRegion. (lib!mpu.MpuRegion.) Poly)
(declare-fun %Poly%lib!mpu.MpuRegion. (Poly) lib!mpu.MpuRegion.)
...
(assert
 (forall ((x slice%<lib!mpu.MpuRegion.>.)) (!
   (= x (%Poly%slice%<lib!mpu.MpuRegion.>. (Poly%slice%<lib!mpu.MpuRegion.>. x)))
   :pattern ((Poly%slice%<lib!mpu.MpuRegion.>. x))
   :qid internal_crate__slice__<lib!mpu.MpuRegion.>_box_axiom_definition
   :skolemid skolem_internal_crate__slice__<lib!mpu.MpuRegion.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (SLICE $ TYPE%lib!mpu.MpuRegion.))
    (= x (Poly%slice%<lib!mpu.MpuRegion.>. (%Poly%slice%<lib!mpu.MpuRegion.>. x)))
   )
   :pattern ((has_type x (SLICE $ TYPE%lib!mpu.MpuRegion.)))
   :qid internal_crate__slice__<lib!mpu.MpuRegion.>_unbox_axiom_definition
   :skolemid skolem_internal_crate__slice__<lib!mpu.MpuRegion.>_unbox_axiom_definition
)))
(assert
 (forall ((x slice%<lib!mpu.MpuRegion.>.)) (!
   (has_type (Poly%slice%<lib!mpu.MpuRegion.>. x) (SLICE $ TYPE%lib!mpu.MpuRegion.))
   :pattern ((has_type (Poly%slice%<lib!mpu.MpuRegion.>. x) (SLICE $ TYPE%lib!mpu.MpuRegion.)))
   :qid internal_crate__slice__<lib!mpu.MpuRegion.>_has_type_always_definition
   :skolemid skolem_internal_crate__slice__<lib!mpu.MpuRegion.>_has_type_always_definition
)))
(assert
...
(assert
 (forall ((x lib!mpu.MpuRegion.)) (!
   (= x (%Poly%lib!mpu.MpuRegion. (Poly%lib!mpu.MpuRegion. x)))
   :pattern ((Poly%lib!mpu.MpuRegion. x))
   :qid internal_lib__mpu__MpuRegion_box_axiom_definition
   :skolemid skolem_internal_lib__mpu__MpuRegion_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%lib!mpu.MpuRegion.)
    (= x (Poly%lib!mpu.MpuRegion. (%Poly%lib!mpu.MpuRegion. x)))
   )
   :pattern ((has_type x TYPE%lib!mpu.MpuRegion.))
   :qid internal_lib__mpu__MpuRegion_unbox_axiom_definition
   :skolemid skolem_internal_lib__mpu__MpuRegion_unbox_axiom_definition
)))
(assert
 (forall ((_base! Int) (_size! Int) (_attr! Int)) (!
   (=>
    (and
     (uInv 32 _base!)
     (uInv 32 _size!)
    ...
    (has_type (Poly%lib!mpu.MpuRegion. (lib!mpu.MpuRegion./MpuRegion _base! _size! _attr!))
     TYPE%lib!mpu.MpuRegion.
   ))
   :pattern ((has_type (Poly%lib!mpu.MpuRegion. (lib!mpu.MpuRegion./MpuRegion _base! _size!
       _attr!
      )
     ) TYPE%lib!mpu.MpuRegion.
   ))
   :qid internal_lib!mpu.MpuRegion./MpuRegion_constructor_definition
   :skolemid skolem_internal_lib!mpu.MpuRegion./MpuRegion_constructor_definition
)))
(assert
 (forall ((x lib!mpu.MpuRegion.)) (!
   (= (lib!mpu.MpuRegion./MpuRegion/base x) (lib!mpu.MpuRegion./MpuRegion/?base x))
   :pattern ((lib!mpu.MpuRegion./MpuRegion/base x))
   :qid internal_lib!mpu.MpuRegion./MpuRegion/base_accessor_definition
   :skolemid skolem_internal_lib!mpu.MpuRegion./MpuRegion/base_accessor_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%lib!mpu.MpuRegion.)
    (uInv 32 (lib!mpu.MpuRegion./MpuRegion/base (%Poly%lib!mpu.MpuRegion. x)))
   )
   :pattern ((lib!mpu.MpuRegion./MpuRegion/base (%Poly%lib!mpu.MpuRegion. x)) (has_type
     x TYPE%lib!mpu.MpuRegion.
   ))
   :qid internal_lib!mpu.MpuRegion./MpuRegion/base_invariant_definition
   :skolemid skolem_internal_lib!mpu.MpuRegion./MpuRegion/base_invariant_definition
)))
(assert
 (forall ((x lib!mpu.MpuRegion.)) (!
   (= (lib!mpu.MpuRegion./MpuRegion/size x) (lib!mpu.MpuRegion./MpuRegion/?size x))
   :pattern ((lib!mpu.MpuRegion./MpuRegion/size x))
   :qid internal_lib!mpu.MpuRegion./MpuRegion/size_accessor_definition
   :skolemid skolem_internal_lib!mpu.MpuRegion./MpuRegion/size_accessor_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%lib!mpu.MpuRegion.)
    (uInv 32 (lib!mpu.MpuRegion./MpuRegion/size (%Poly%lib!mpu.MpuRegion. x)))
   )
   :pattern ((lib!mpu.MpuRegion./MpuRegion/size (%Poly%lib!mpu.MpuRegion. x)) (has_type
     x TYPE%lib!mpu.MpuRegion.
   ))
   :qid internal_lib!mpu.MpuRegion./MpuRegion/size_invariant_definition
   :skolemid skolem_internal_lib!mpu.MpuRegion./MpuRegion/size_invariant_definition
)))
(assert
 (forall ((x lib!mpu.MpuRegion.)) (!
   (= (lib!mpu.MpuRegion./MpuRegion/attr x) (lib!mpu.MpuRegion./MpuRegion/?attr x))
   :pattern ((lib!mpu.MpuRegion./MpuRegion/attr x))
   :qid internal_lib!mpu.MpuRegion./MpuRegion/attr_accessor_definition
   :skolemid skolem_internal_lib!mpu.MpuRegion./MpuRegion/attr_accessor_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%lib!mpu.MpuRegion.)
    (uInv 32 (lib!mpu.MpuRegion./MpuRegion/attr (%Poly%lib!mpu.MpuRegion. x)))
   )
   :pattern ((lib!mpu.MpuRegion./MpuRegion/attr (%Poly%lib!mpu.MpuRegion. x)) (has_type
     x TYPE%lib!mpu.MpuRegion.
   ))
   :qid internal_lib!mpu.MpuRegion./MpuRegion/attr_invariant_definition
   :skolemid skolem_internal_lib!mpu.MpuRegion./MpuRegion/attr_invariant_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
;; Function-Decl lib::mpu::MIN_REGION_SIZE
(declare-fun lib!mpu.MIN_REGION_SIZE.? () Int)

;; Function-Decl lib::mpu::MAX_REGIONS_V7
(declare-fun lib!mpu.MAX_REGIONS_V7.? () Int)

;; Function-Decl lib::mpu::MAX_REGIONS_V8
(declare-fun lib!mpu.MAX_REGIONS_V8.? () Int)

;; Function-Decl lib::mpu::is_pow2_spec
(declare-fun lib!mpu.is_pow2_spec.? (Poly) Bool)
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (slice! Poly)) (!
    ...
    :pattern ((vstd!slice.spec_slice_len.? T&. T& slice!))
    :qid user_vstd__slice__axiom_spec_len_5
    :skolemid skolem_user_vstd__slice__axiom_spec_len_5
))))
     ...
     (=>
      ...
      (= (ext_eq false (SLICE T&. T&) a1! a2!) (and
        ...
        (forall ((i$ Poly)) (!
          ...
          :qid user_vstd__slice__axiom_slice_ext_equal_6
          :skolemid skolem_user_vstd__slice__axiom_slice_ext_equal_6
    ))))))
    :pattern ((ext_eq false (SLICE T&. T&) a1! a2!))
    :qid user_vstd__slice__axiom_slice_ext_equal_7
    :skolemid skolem_user_vstd__slice__axiom_slice_ext_equal_7
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (slice! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__slice__axiom_slice_has_resolved_8
    :skolemid skolem_user_vstd__slice__axiom_slice_has_resolved_8
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (a! Poly)) (!
    ...
    :qid user_vstd__raw_ptr__ptrs_mut_eq_9
    :skolemid skolem_user_vstd__raw_ptr__ptrs_mut_eq_9
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (a! Poly)) (!
    ...
    :pattern ((vstd!view.View.view.? $ (PTR T&. T&) a!))
    :qid user_vstd__raw_ptr__ptrs_mut_eq_sized_10
    :skolemid skolem_user_vstd__raw_ptr__ptrs_mut_eq_sized_10
))))
...
(assert
 (forall ((closure%$ Poly) (Self%&. Dcr) (Self%& Type)) (!
   ...
   :qid user_core__clone__Clone__clone_11
   :skolemid skolem_user_core__clone__Clone__clone_11
)))
...
(assert
 (forall ((closure%$ Poly) (res$ Poly)) (!
   ...
   :qid user_core__clone__impls__impl&%9__clone_12
   :skolemid skolem_user_core__clone__impls__impl&%9__clone_12
)))
...
(assert
 (forall ((closure%$ Poly) (res$ Poly)) (!
   ...
   :qid user_core__clone__impls__impl&%15__clone_13
   :skolemid skolem_user_core__clone__impls__impl&%15__clone_13
)))
...
(assert
 (forall ((x! Int) (y! Int) (%return! core!option.Option.)) (!
   (= (ens%core!num.impl&%8.checked_add. x! y! %return!) (and
     (has_type (Poly%core!option.Option. %return!) (TYPE%core!option.Option. $ (UINT 32)))
     (= %return! (ite
       (> (Add x! y!) 4294967295)
       core!option.Option./None
       (core!option.Option./Some (I (uClip 32 (Add x! y!))))
   ))))
   :pattern ((ens%core!num.impl&%8.checked_add. x! y! %return!))
...
(assert
 (forall ((closure%$ Poly) (%return$ Poly)) (!
   ...
   :qid user_core__clone__impls__impl&%41__clone_14
   :skolemid skolem_user_core__clone__impls__impl&%41__clone_14
)))
...
(assert
 (forall ((closure%$ Poly) (res$ Poly) (T&. Dcr) (T& Type)) (!
   ...
   :qid user_core__clone__impls__impl&%6__clone_15
   :skolemid skolem_user_core__clone__impls__impl&%6__clone_15
)))
...
(assert
 (forall ((closure%$ Poly) (res$ Poly) (T&. Dcr) (T& Type)) (!
   ...
   :qid user_verus_builtin__impl&%5__clone_16
   :skolemid skolem_user_verus_builtin__impl&%5__clone_16
)))
...
(assert
 (forall ((closure%$ Poly) (res$ Poly) (T&. Dcr) (T& Type)) (!
   ...
   :qid user_verus_builtin__impl&%3__clone_17
   :skolemid skolem_user_verus_builtin__impl&%3__clone_17
)))
...
(assert
 (forall ((closure%$ Poly) (res$ Poly) (T&. Dcr) (T& Type)) (!
   ...
   :qid user_core__option__impl&%5__clone_18
   :skolemid skolem_user_core__option__impl&%5__clone_18
)))
...
(assert
 (forall ((closure%$ Poly) (res$ Poly) (T&. Dcr) (T& Type) (A&. Dcr) (A& Type)) (!
   ...
   :qid user_alloc__boxed__impl&%15__clone_19
   :skolemid skolem_user_alloc__boxed__impl&%15__clone_19
)))
...
;; Function-Axioms lib::mpu::MIN_REGION_SIZE
(assert
 (fuel_bool_default fuel%lib!mpu.MIN_REGION_SIZE.)
)
(assert
 (=>
  (fuel_bool fuel%lib!mpu.MIN_REGION_SIZE.)
  (= lib!mpu.MIN_REGION_SIZE.? 32)
))
(assert
 (uInv 32 lib!mpu.MIN_REGION_SIZE.?)
)

;; Function-Axioms lib::mpu::MAX_REGIONS_V7
(assert
 (fuel_bool_default fuel%lib!mpu.MAX_REGIONS_V7.)
)
(assert
 (=>
  (fuel_bool fuel%lib!mpu.MAX_REGIONS_V7.)
  (= lib!mpu.MAX_REGIONS_V7.? 8)
))
(assert
 (uInv 32 lib!mpu.MAX_REGIONS_V7.?)
)

;; Function-Axioms lib::mpu::MAX_REGIONS_V8
(assert
 (fuel_bool_default fuel%lib!mpu.MAX_REGIONS_V8.)
)
(assert
 (=>
  (fuel_bool fuel%lib!mpu.MAX_REGIONS_V8.)
  (= lib!mpu.MAX_REGIONS_V8.? 16)
))
(assert
 (uInv 32 lib!mpu.MAX_REGIONS_V8.?)
)

;; Function-Axioms lib::mpu::is_pow2_spec
(assert
 (fuel_bool_default fuel%lib!mpu.is_pow2_spec.)
)
(assert
 (=>
  (fuel_bool fuel%lib!mpu.is_pow2_spec.)
  (forall ((n! Poly)) (!
    (= (lib!mpu.is_pow2_spec.? n!) (or
      (or
       (or
        (or
         (or
    ...
    :pattern ((lib!mpu.is_pow2_spec.? n!))
    :qid internal_lib!mpu.is_pow2_spec.?_definition
    :skolemid skolem_internal_lib!mpu.is_pow2_spec.?_definition
))))
...
;; Function-Specs lib::mpu::MpuRegion::clone
(declare-fun ens%lib!mpu.impl&%1.clone. (Poly Poly) Bool)
(assert
 (forall ((self! Poly) (%return! Poly)) (!
   (= (ens%lib!mpu.impl&%1.clone. self! %return!) (and
     (ens%core!clone.Clone.clone. $ TYPE%lib!mpu.MpuRegion. self! %return!)
     (= %return! self!)
   ))
   :pattern ((ens%lib!mpu.impl&%1.clone. self! %return!))
   :qid internal_ens__lib!mpu.impl&__1.clone._definition
   :skolemid skolem_internal_ens__lib!mpu.impl&__1.clone._definition
)))
(assert
 (forall ((closure%$ Poly) (%return$ Poly)) (!
   (=>
    (and
     (has_type closure%$ (TYPE%tuple%1. (REF $) TYPE%lib!mpu.MpuRegion.))
     (has_type %return$ TYPE%lib!mpu.MpuRegion.)
    )
    (=>
     (closure_ens (FNDEF%core!clone.Clone.clone. $ TYPE%lib!mpu.MpuRegion.) (DST (REF $))
      (TYPE%tuple%1. (REF $) TYPE%lib!mpu.MpuRegion.) (F fndef_singleton) closure%$ %return$
     )
     (let
      ((self$ (%Poly%lib!mpu.MpuRegion. (tuple%1./tuple%1/0 (%Poly%tuple%1. closure%$)))))
      (= (%Poly%lib!mpu.MpuRegion. %return$) self$)
   )))
   :pattern ((closure_ens (FNDEF%core!clone.Clone.clone. $ TYPE%lib!mpu.MpuRegion.) (DST
      (REF $)
     ) (TYPE%tuple%1. (REF $) TYPE%lib!mpu.MpuRegion.) (F fndef_singleton) closure%$ %return$
   ))
   :qid user_lib__mpu__MpuRegion__clone_20
   :skolemid skolem_user_lib__mpu__MpuRegion__clone_20
)))

;; Trait-Impl-Axiom
(assert
 (tr_bound%core!clone.Clone. $ TYPE%lib!mpu.MpuRegion.)
)

;; Function-Specs lib::mpu::is_power_of_two
(declare-fun ens%lib!mpu.is_power_of_two. (Int Bool) Bool)
(assert
 (forall ((n! Int) (result! Bool)) (!
   (= (ens%lib!mpu.is_power_of_two. n! result!) (= result! (lib!mpu.is_pow2_spec.? (I n!))))
   :pattern ((ens%lib!mpu.is_power_of_two. n! result!))
   :qid internal_ens__lib!mpu.is_power_of_two._definition
   :skolemid skolem_internal_ens__lib!mpu.is_power_of_two._definition
)))

;; Function-Def lib::mpu::is_power_of_two
;; src/mpu.rs:98:9: 98:15 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= (and
     (bvugt n! ((_ zero_extend 31) (_ bv0 1)))
     (= (bvand n! (bvsub n! ((_ zero_extend 31) (_ bv1 1)))) ((_ zero_extend 31) (_ bv0 1)))
    ) (or
     (or
      (or
       (or
                              ...
                              (or
                               (or
                                (or
                                 (or
                                  (or
                                   (= n! ((_ zero_extend 31) (_ bv1 1)))
                                   (= n! ((_ zero_extend 30) (_ bv2 2)))
                                  )
                                  (= n! ((_ zero_extend 29) (_ bv4 3)))
                                 )
                                 (= n! ((_ zero_extend 28) (_ bv8 4)))
                                )
                                (= n! ((_ zero_extend 27) (_ bv16 5)))
                               )
                               (= n! ((_ zero_extend 26) (_ bv32 6)))
                              )
                              (= n! ((_ zero_extend 25) (_ bv64 7)))
                             )
                             (= n! ((_ zero_extend 24) (_ bv128 8)))
                            )
                            (= n! ((_ zero_extend 23) (_ bv256 9)))
                           )
                           (= n! ((_ zero_extend 22) (_ bv512 10)))
                          )
                          (= n! ((_ zero_extend 21) (_ bv1024 11)))
                         )
                         (= n! ((_ zero_extend 20) (_ bv2048 12)))
                        )
                        (= n! ((_ zero_extend 19) (_ bv4096 13)))
                       )
                       (= n! ((_ zero_extend 18) (_ bv8192 14)))
                      )
                      (= n! ((_ zero_extend 17) (_ bv16384 15)))
                     )
                     (= n! ((_ zero_extend 16) (_ bv32768 16)))
                    )
                    (= n! ((_ zero_extend 15) (_ bv65536 17)))
                   )
                   (= n! ((_ zero_extend 14) (_ bv131072 18)))
                  )
                  (= n! ((_ zero_extend 13) (_ bv262144 19)))
                 )
                 (= n! ((_ zero_extend 12) (_ bv524288 20)))
                )
                (= n! ((_ zero_extend 11) (_ bv1048576 21)))
               )
               (= n! ((_ zero_extend 10) (_ bv2097152 22)))
              )
              (= n! ((_ zero_extend 9) (_ bv4194304 23)))
             )
             (= n! ((_ zero_extend 8) (_ bv8388608 24)))
            )
            (= n! ((_ zero_extend 7) (_ bv16777216 25)))
           )
           (= n! ((_ zero_extend 6) (_ bv33554432 26)))
          )
          (= n! ((_ zero_extend 5) (_ bv67108864 27)))
         )
         (= n! ((_ zero_extend 4) (_ bv134217728 28)))
        )
        (= n! ((_ zero_extend 3) (_ bv268435456 29)))
       )
       (= n! ((_ zero_extend 2) (_ bv536870912 30)))
      )
      (= n! ((_ zero_extend 1) (_ bv1073741824 31)))
     )
     (= n! (_ bv2147483648 32))
)))))
(get-info :all-statistics)
