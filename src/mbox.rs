...
// =====================================================================
// Post-scan action decisions (for FFI gale_k_mbox_*_decide)
// =====================================================================
...
pub fn put_action_decide(matched: bool, is_no_wait: bool) -> (result: MboxPutAction)
    ensures
        matched ==> result === MboxPutAction::Matched,
        !matched && is_no_wait ==> result === MboxPutAction::ReturnEnomsg,
        !matched && !is_no_wait ==> result === MboxPutAction::PendTx,
{
    if matched {
...
pub fn get_action_decide(matched: bool, is_no_wait: bool) -> (result: MboxGetAction)
    ensures
        matched ==> result === MboxGetAction::Consume,
        !matched && is_no_wait ==> result === MboxGetAction::ReturnEnomsg,
        !matched && !is_no_wait ==> result === MboxGetAction::PendRx,
{
    if matched {
