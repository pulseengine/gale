...
pub fn event_init_decide(event_type: u32) -> (result: u32)
    ensures
        // PL1: state is always NOT_READY after init.
...
pub fn signal_reset_decide() -> (result: u32)
    ensures
        // PL8: signaled is always cleared to 0.
        result == 0u32,
{
    0u32
}
