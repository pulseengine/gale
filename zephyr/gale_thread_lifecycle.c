 ...
 *
 * Gale thread_lifecycle — full thread.c replacement.
 *
 * This is upstream kernel/thread.c with Gale decision struct integration
 * at create/abort/join decision points. All exported thread symbols provided.
 */
